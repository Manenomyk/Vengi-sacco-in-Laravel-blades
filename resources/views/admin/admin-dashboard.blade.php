    ...
    <section class="home-section">
      <div class="home-content">
        <div class="overview-boxes">
          <div class="box" style="background-color: rgb(104, 144, 136);">
          ...
          <div class="box" style="background-color: rgb(99, 155, 91);">
            <div class="right-side" >
          ...
          <div class="box" style="background-color: rgb(114, 135, 74);">
            <div class="right-side">
          ...
          <div class="box" style="background-color: rgb(159, 143, 108);">
            <div class="right-side">
