        ...
        <div class="home-content">
            <div class="space-content">
                <div class="pdf" style="display: flex; flex-direction:row; ">
                    <form action="{{ url('view-emergency-pdf') }}" method="post" enctype="multipart/form-data"
                        target="blank">
                        @csrf
                        <button type="submit"
            ...
            <div class="container">
                ...
                <div class="table">
                    <table>
                        ...
                        <tbody>
                            @if (count($emergency_loans) == 0)
                                <tr>
                                    <td colspan="10" style="text-align: center"><b>Hey! No emergency loans at the
                                            moment</b>
                                    </td>
                                </tr>
                            @else
                                @foreach ($emergency_loans as $item)
                                    <tr>
                                        ...
                                        @if ($item->is_approved == 0)
                                            <td>
                                                <div class="button1">
                                                    <form action="{{ url('auth-approve-emergency/' . $item->id) }}"
