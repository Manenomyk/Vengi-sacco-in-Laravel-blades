                ...
                <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="button1">
                            <form action="{{ url('authorizer-approve-member/'.$item->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <input type = "hidden" name = "approve" value = "1" />
                              <button class="btn2" type="submit" style="background-color: rgb(109, 207, 109);"> Approve Member</button>
                            </form>
                           </div>
                      </td>
                      <td>
